...
<head>
    ...
    <script src="{{env("APP_URL")}}/static/index/js/jquery.min.js"></script>
    <script src="{{env("APP_URL")}}/static/index/js/materialize.min.js"></script>
    <script src="{{env("APP_URL")}}/static/index/js/owl.carousel.min.js"></script>
    <script src="{{env("APP_URL")}}/static/index/js/fakeLoader.min.js"></script>
    <script src="{{env("APP_URL")}}/static/index/js/animatedModal.min.js"></script>
    <script src="{{env("APP_URL")}}/static/index/js/main.js"></script>
    <script src="{{env("APP_URL")}}/static/index/js/alert.js"></script>
